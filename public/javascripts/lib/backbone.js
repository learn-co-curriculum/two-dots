...
(function(factory) {
    ...
    var offApi = function(events, name, callback, options) {
        ...
        for (; i < names.length; i++) {
            ...
            for (var j = 0; j < handlers.length; j++) {
                ...
                if (
                callback && callback !== handler.callback && callback !== handler.callback._callback || context && context !== handler.context) {
    ...
    _.extend(History.prototype, Events, {
        ...
        getPath: function() {
            ...
            this.location.pathname + this.getSearch()).slice(this.root.length - 1);
